...
<div class="new-elm">
    ...
    <div class="cat-wrapper cat-right">
        ${category(
					'https://shop.carpetmart.com/carpet/',
					'https://i.shgcdn.com/1852b472-894f-4286-877b-a627ae848f8e/-/format/auto/-/preview/3000x3000/-/quality/lighter/',
					'Shop Carpet'
				)}
        ${category(
					'https://shop.carpetmart.com/luxury-vinyl-flooring',
					'https://i.shgcdn.com/2353f9ed-3ed9-45ed-9a88-aa7f27bbee8d/-/format/auto/-/preview/3000x3000/-/quality/lighter/',
					'Shop Vinyl'
				)}
    </div>
    <div class="cat-wrapper cat-left">
        ${category(
					'https://shop.carpetmart.com/rugs',
					'https://i.shgcdn.com/14e7702a-07db-49b1-9e85-7f66da5bc05f/-/format/auto/-/preview/3000x3000/-/quality/lighter/',
					'Shop Area Rugs'
				)}
        ${category(
					'https://shop.carpetmart.com/tile',
					'https://i.shgcdn.com/c74bff7c-7f3e-4859-bc5a-b047a8194ea9/-/format/auto/-/preview/3000x3000/-/quality/lighter/',
					'Shop Tile'
				)}
    </div>
    <div class="usp-store">
        ${uspDetails(location_svg, 'Find A Store')}
        ${uspDetails(measure_svg, 'Schedule a sMeasurement')}
        ${uspDetails(saving_svg, 'Want Savings?')}
    </div>
    <div class="cat-wrapper cat-equal">
        ${category(
					'https://shop.carpetmart.com/hardwood',
					'https://i.shgcdn.com/3d590063-b2d2-4be6-adfc-966c2fbcc617/-/format/auto/-/preview/3000x3000/-/quality/lighter/',
					'Shop Hardwood'
				)}
        ${category(
					'https://shop.carpetmart.com/laminate',
					'https://i.shgcdn.com/1c803b28-c54f-439b-88fd-0edcf53fc844/-/format/auto/-/preview/3000x3000/-/quality/lighter/',
					'Shop Laminate'
				)}
    </div>
</div>
