...
<style>
    ...
    .roomvo-stimr {
        border: 1px solid #F4AC96!important;
        display: flex!important;
        border-radius: 4px;
        align-items: center;
        gap: 20px;
    }
    .roomvo-stimr .message-info {
        display: flex;
...
<div class="message-info">
    <h6>See How This Rug Looks in Your Room -</h6>
    <small>Takes Just 5 Seconds!</small>
</div>
<svg
	width="12"
	height="12"
...
>
	<path
		d="M0 6H11M11 6L6.03226 1M11 6L6.03226 11"
		stroke="#333333"
		stroke-width="1.4"
	/>
</svg>
