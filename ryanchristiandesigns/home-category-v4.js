const collectionName = ['Bracelets', 'Chains', 'Rings', 'Women', 'Men'];
...
<style>
    ...
    .category-content .collection-collage__item:nth-of-type(2) .collection-grid__item-overlay{
        background-image: url(https://i.ibb.co/54PsXYL/Look-5-S6-364.jpg) !important;
    }
    .category-content .collection-collage__item:nth-of-type(3) .collection-grid__item-overlay{
        background-image: url(https://i.ibb.co/KhKgrBd/Look-2-S2-117.jpg) !important;
    }
