...
<style>
   ...
   .addthis_toolbox.addthis_32x32_style,.productView-related--desktop{
        display:none;
    }
   ...
   @media only screen and (max-width:480px){
       ...
       .form-field.form-field--increments.productView-price--wrapper .form-increment input{
        ...
        .productView-info{
        margin-bottom:0;}
        .productView-short-description> ul,.productView-info{
        margin-bottom:0;
        margin-top:4px;
        }
...
const rev_int = setInterval(() => {
	...
	const rev = document.querySelector(
		'.productView-product .stjr-product-rating.stjr-init'
	);
